        ...
        <div className='cv row'>
                ...
                <div className='maimnSkils'>
                    <h2>Main skils</h2>
                      ...
                      <div class="progress-bar" role="progressbar" style={{width: "90%"}} aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                         ...
                         <h6>structures and algorithms  </h6>
                         <div class="progress">
            ...
            <div className=' right col'>
                ...
                <div className='summary'>
                    <h3>SUMMARY</h3>
                    <ul>
                        <li>In the third year of the Faculty of Informatics Engineering</li>
                        <li>experience in building and maintaining websites useing React js </li>
                ...
                <div className='experience'>
                    ...
                    <ul>
                        ...
                        <li>Building stable and maintainable codeases useing React</li>
